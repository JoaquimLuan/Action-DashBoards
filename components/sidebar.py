...
layout = dbc.Card([
                #html.H1("Grupo Action", className="text-primary"),
                html.H1(children=[html.Img(src='/assets/Logo_01.png', id='avatar-change', alt='Avatar', className='perfil_avatar')
                ], style={'background-color': 'transparent', 'border-color': 'transparent', 'alling': 'center'}),
                html.P("Action BI", className="text-info"),
                html.Hr(),
...
# Seção NAV ------------------------
            ...
            ThemeChangerAIO(aio_id="theme", radio_props={"value":dbc.themes.SUPERHERO})
